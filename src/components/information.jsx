    ...
    <section className="bg-white py-16">
      <div className="container flex flex-col md:flex-row gap-5 md:gap-6 min-h-[660px]">
        ...
        <div className="text-dark text-right flex flex-col items-stretch gap-5">
          ...
          <div className="flex pr-1  gap-1 md:pr-3 justify-end">
            <p className="text-md text-right w-full">منابع انسانی یک دارایی بسیار ضروری برای هر محیط کاری است که باید با اجرای یک برنامه ایمنی و بهداشت قوی محافظت شود</p>
            <FaLeaf className="text-lightGreen size-5"></FaLeaf>
          </div>
          <div className="flex pr-1 gap-1 md:pr-3 justify-end">
          ...
          <div className="flex pr-1 gap-1 md:pr-3 justify-end">
            <p className="text-md text-right w-full">مسئولیت اساسی هر شرکت و کارمند به حداقل رساندن تأثیرات زیست محیطی در جایی است که در آن فعالیت می کنیم و بر HSE و رفاه در محل کار تمرکز می کنیم.</p>
            <FaLeaf className="text-lightGreen size-5"></FaLeaf>
          </div>
          <div className="flex pr-1 gap-1 md:pr-3 justify-end">
            <p className="text-md text-right w-full">پیاده‌سازی HSE به عنوان یک سیستم مدیریت جامع، نه تنها به بهبود عملکرد و ایمنی سازمان کمک می‌کند، بلکه به موفقیت و پایداری آن در بازارهای مختلف نیز کمک می‌کند.</p>
            <FaLeaf className="text-lightGreen size-5"></FaLeaf>
          </div>
         </div>
      </div>
