        ...
        <div className="container mx-auto pb-16 px-4 sm:px-6 lg:px-8">
            ...
            <motion.div viewport={{once:true}} initial={{opacity:0 , x:-60}} whileInView={{opacity:1, x:1}} transition={{delay:0.5, duration:0.9, easeInOut}} className="w-full h-full justify-self-end">
                ...
                <div className="mt-12  border-4  md:mt-10 bg-[url('../../public/assets/hseHeader.jpg')] shadow-lg h-72 bg-cover bg-no-repeat relative rounded">
                    <motion.div viewport={{once:true}} initial={{opacity:0 , x:60}} whileInView={{opacity:1, x:1}} transition={{delay:0.5, duration:0.9, easeInOut}} className='hidden sm:block h-[200px] w-[240px] bg-accent-hover shadow-xl  xl:left-1/2  rounded relative'>
