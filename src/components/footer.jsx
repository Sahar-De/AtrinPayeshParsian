    ...
    <div className="container px-6 py-12 mx-auto" >
        ...
        <div>
          ...
          <div className="flex flex-col items-start mt-5 space-y-2">
            ...
            <a
              ...
              className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-accent-hover hover:underline hover:text-accent-hover"
            >
              ایمیل: info@atrin.com
            </a>
            <a
              href="#"
              className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-accent-hover hover:underline hover:text-accent-hover"
            >
              آدرس: بلوار میرداماد داودیه پلاک 194
            </a>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex -mx-2">
          <a
            href="#"
            className="mx-2 text-gray-600 transition-colors duration-300  hover:text-accent-hover dark:text-accent-hover"
            aria-label="Reddit"
          >
            <svg
          ...
          <a
            href="#"
            className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-accent-hover dark:hover:text-accent-hover"
            aria-label="Facebook"
          >
            <svg
              className="w-5 h-5 fill-current"
