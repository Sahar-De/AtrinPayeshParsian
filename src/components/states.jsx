    ...
    <section id="states" className=" py-24 flex items-center rightToLeft bg-primary">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row gap-6 max-w-[80vm] md:max-w-none p-5 md:p-16 md:rounded-xl md:drop-shadow-lg md:bg-gray-200">
          {states.map((item,index)=>{return(<motion.div viewport={{once:true}} initial={{y:50}} whileInView={{y:0, transition:{delay:index*0.2 , duration:0.9 , ease:"easeIn"}}} className="flex flex-1 gap-4 items-center justify-center" key={index}>
